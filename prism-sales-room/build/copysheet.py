...
JOHNS = set()  # every Prism Specialties page is mine to ship
...
PAGE = """<title>Prism Specialties MEG - Page Source for CMS Upload</title>
<script>
...
<style>
:root{
  --ink:#12151A; --paper:#FAF9F6; --card:#FFFFFF; --pink:#005BA7; --pink-dk:#004A88;
...
:root[data-theme="light"]{--ink:#12151A; --paper:#FAF9F6; --card:#FFFFFF; --line:#E5E2DC;
  --slate:#5B6470; --pink:#005BA7; --pink-dk:#004A88; --ok:#0F7B4F;
  --header:#12151A; --on-header:#FFFFFF; --on-header-dim:#B9C0C9; --btn-tx:#FAF9F6}
