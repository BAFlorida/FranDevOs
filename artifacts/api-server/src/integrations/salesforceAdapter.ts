...
// (seeded as if a Salesforce sync had already reconciled them). The TODO
// markers below are the exact seams a future implementation replaces with live
// Salesforce calls — no route, contract, schema or UI change is required.
