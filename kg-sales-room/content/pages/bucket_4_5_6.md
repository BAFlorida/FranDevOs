# SOURCE COPY — Buckets 4, 5, 6

Original MEG language, brand-swapped to Kitchen Guard. Render this copy as written.
...
[PLACEHOLDER: KG selectivity figures. John wants the placeholder stats replaced with real numbers. The original read "fewer than 5% of candidates introduced to a Franchise Developer are eventually invited to Meet The Team Day" and "statistically, only 2 out of 3 candidates who attend are awarded a franchise." Pull KG's actuals before publishing.]

### H2: Who You Will Meet

John Dobelbower and the Kitchen Guard brand leader will meet with you, and with your spouse or partner if they are part of this decision. The brand leader speaks with every candidate before Meet The Team Day.
...
You saw these agreements listed in FDD Item 22. Now you will see them filled in for your specific situation. Your territory, your fee, your equity injection, your dates.

### H2: What Your Franchise Developer Needs From You
...
| 9 | Bio | Your Franchise Developer writes an executive bio. You provide a family photo |
...
## PAGE: 05-meet-the-team-day/index.html
...
This is the biggest step in the process.

You will leave the virtual world behind, come see us in person, meet the leadership team, tour the operation, and go deep on the business in ways no video call can match.
...
[VIDEO: EverSmith Meet The Team Day]
...
Download and bring the workbook below. You will use it throughout the day.

[DOWNLOAD: Kitchen Guard Meet The Team Day Handout]

### H2: One Form to Save for Later

You will also see a form titled "Reasons to Become or Not Become a Franchise Owner."
...
Our last speaker of the day will prompt you to complete this form near the end of the event.
...
## PAGE: 06-agreement-stage/index.html
...
[VIDEO: EverSmith Executive Board Approval]

Your Franchise Developer presents you to our Executive Committee.

**They have no vote.**

That is deliberate. Your Franchise Developer's role in that room is to be your biggest cheerleader. To present your background, your territory, how you moved through the process, and why they believe you fit. The decision belongs to the committee.

### H2: Three Questions First

Your Franchise Developer will not present you until you can answer YES to all three.

1. Have all your questions regarding the brand been answered?
2. Have all your questions regarding the franchise agreement been answered?
3. Are you committed to the established timeline if awarded?

If any answer is no, we slow down. That is not a setback. It is the process working.

### H2: The Decision Comes the Same Day

You will not wait a week. After deliberations, a member of the committee calls you directly.

There are three possible outcomes.

### H3: 1. Full Approval

You are awarded. Your Franchise Developer moves you into execution.

### H3: 2. Conditional Approval

You receive full approval once a specific condition is met. Common examples are a clarification on a background item, or a funding milestone that needs to land first.

Once the condition is satisfied, conditional approval converts to full approval. Your Franchise Developer will be explicit about what is needed and by when.

### H3: 3. Not Approved

This is a healthy outcome, and we mean that.

If the committee believes you would struggle in this business, or that this investment would put you in financial difficulty, they will not award you a franchise. **We will not put people in financial peril.**

A member of the committee will explain the reasoning directly. They will also offer guidance on where they think you would do better, inside the portfolio or outside it.

Some candidates come back to us in a year or two when their situation has changed. That door stays open.

### NEXT
On approval, continue to Executing Your Franchise Agreement.
...
[VIDEO: EverSmith Agreement Execution]

You have successfully navigated one of the most selective franchise development processes in the world.

### H2: What Happens Now

DocuSign sends you a link to Step 2 of execution. Your password is the same one you used for the Step 1 acknowledgment in Stage 4. If you cannot find it, Legal can resend.
...
7. Countersignature routing. [PLACEHOLDER: confirm the KG / EverSmith countersignature chain.] You receive a fully executed copy when it is complete.
...
[PLACEHOLDER: KG referral program name and all figures. The original structure was $5,000 per successful placed referral, a quarterly $1,350 drawing, Reunion travel comp, and a live $5,000 Reunion drawing, on an April 1 to March 31 award year. Replace every figure with KG's actual program, or remove this section if none exists yet.]
...
The franchise development process can feel long and arduous. But when we slow down on the front end, we can really speed up on the back end.

You asked hard questions. You talked to owners. You looked honestly at your finances and your family. You did the work.

Welcome to Kitchen Guard.
