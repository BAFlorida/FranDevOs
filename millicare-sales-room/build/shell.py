"""Page shell for the MilliCare MEG sales room.
...
No brand book has been supplied for MilliCare; the palette is taken
from the supplied draft template as authored (Centra No.2 with Poppins fallback).
"""
...
if os.path.exists(LOGO_B64):
    ...
    if _b64:
        ...
        LOGO = ('<div class="logo-plate"><img class="brandmark" '
                f'src="data:image/png;base64,{_b64}" alt="MilliCare" '
                'width="720" height="127" fetchpriority="high" decoding="sync"></div>')
        LOGO_MISSING = False
...
<span class="sub">MilliCare · Mutual Evaluation Guide</span>
...
<span>MilliCare · An EverSmith Brands Company</span></footer>
</body></html>
"""
