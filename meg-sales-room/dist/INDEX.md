...
| 13 | Executive Approval Call | `04-seeking-approval/01-executive-approval-call.html` | - | 3 | 1 pending |
| 14 | Development Action Plan / Contingencies | `04-seeking-approval/02-dap-contingencies.html` | - | 1 | 1 pending |
| 15 | Meet The Team Day | `05-meet-the-team-day/index.html` | - | - | - |
| 16 | What / Who to Expect at Meet The Team Day | `05-meet-the-team-day/01-what-who-to-expect.html` | - | 2 | 1 embed |
| 17 | Pre Meet The Team Day Questionnaire | `05-meet-the-team-day/02-pre-mttd-questionnaire.html` | - | 2 | 1 embed |
| 18 | Meet The Team Day _(No source - stub)_ | `05-meet-the-team-day/03-meet-the-team-day.html` | - | 10 | 1 pending |
...
| 21 | Executive Board Approval | `06-agreement-stage/01-executive-board-approval.html` | - | 2 | 1 embed |
| 22 | Executing Your Franchise Agreement | `06-agreement-stage/02-executing-your-agreement.html` | - | 3 | 1 embed |
...
| Ref | Pages |
|---|---|
| `PH-01` | `01-welcome/01-mep-end-to-end.html`, `04-seeking-approval/01-executive-approval-call.html` |
...
| `PH-07` | `02-brand-overview/02-fdd.html`, `03-validation/01-owner-calls.html` |
| `PH-09` | `02-brand-overview/01-qualification-summary.html` |
| `PH-10` | `02-brand-overview/01-qualification-summary.html`, `05-meet-the-team-day/02-pre-mttd-questionnaire.html` |
| `PH-11` | `02-brand-overview/03-additional-resources.html` |
| `PH-12` | `02-brand-overview/03-additional-resources.html` |
...
| `PH-16` | `06-agreement-stage/04-thank-you.html` |
...
`BUILD_PROMPT.md` points at `content/source/*.md` (the six stage lessons). Those files were **not** included in the upload, so no source prose was available to adapt.

Where the spec calls for source copy to be preserved verbatim, the page carries the correct heading, the correct interactive elements, and an amber `SRC` flag naming exactly what has to be restored. No source prose was invented to fill those gaps. Specifically still needed:

- 2.1 - exact wording of the credit report self-pull steps 4 through 7
- 3.2 - the Personal Financial Statement filing-requirement list, and the ROBS four-step wording
- 4.2 - the ten-item document checklist
- 6.1 - the three yes questions the FD must clear before presenting
- 6.2 - the seven execution notes, and the three acceptable Schedule D answers

Two pages have no source content at all by design (5.3 Meet The Team Day and 6.3 Brand Welcome Call) and ship as structured stubs, per `CONTENT_MAP.md`.
...
| `02-brand-overview/02-fdd.html` | EverSmith FDD Overview | `udCsGBIY1Rs` |
...
| `04-seeking-approval/02-dap-contingencies.html` | DAP and Document Acknowledgment |
