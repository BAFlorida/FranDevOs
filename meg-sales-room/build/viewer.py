...
BRAND = "1-Tom-Plumber"
JOHNS = {"01-welcome/index.html", "01-welcome/01-mep-end-to-end.html",
...
.own{{display:inline-block;font-family:var(--mono);font-size:9px;letter-spacing:.1em;text-transform:uppercase;border:1px solid var(--edge);color:var(--dim);padding:1px 5px;margin-left:6px}}
...
<nav class="side" id="side">
  <div class="brand">
    ...
    <div class="brand__s">19 mine · 5 John · 5 gates</div>
  </div>
  {''.join(nav)}
</nav>
